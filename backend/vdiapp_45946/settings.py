"""
Django settings for vdiapp_45946 project.
...
ROOT_URLCONF = 'vdiapp_45946.urls'
...
WSGI_APPLICATION = 'vdiapp_45946.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "vdiapp_45946 API",
    "DESCRIPTION": "API documentation for vdiapp_45946 App",
    "VERSION": "v1",
}
